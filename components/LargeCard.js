    ...
    return (
        <section className="relative py-16 cursor-pointer">
            ...
            <div className="absolute top-32 sm:top-40 left-12">
                <h3 className="text-center font-bold pb-2 sm:text-left text-4xl text-black mb-3 w-64 ">{title}</h3>
                <p className="text-black">{description}</p>
            </div>                
            <div className="absolute top-64 pt-4 sm:pt-0 sm:top-72 left-24 sm:left-12">
